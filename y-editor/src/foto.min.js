class Foto {
    ...
    applyVintageFilter() {
        this.colorFilter("#0000ff"), this.colorFilter("#0000ff"), this.colorFilter("#ec8900")
    }
    applyCustom() {
        this.applyFilter([
            [-1, -1, -1],
    ...
    rotate(t) {
        ...
        this.operationOrgCtx.save(), this.operationOrgCtx.translate(this.imageWidth / 2, this.imageHeight / 2),
        this.operationOrgCtx.rotate(t * Math.PI / 180),
        this.operationOrgCtx.drawImage(this.image, -this.image.width / 2, -this.image.width / 2),
        this.operationOrgCtx.restore(), this.imageData = this.operationOrgCtx.getImageData(0, 0,
        this.operationOrgCanvas.width, this.operationOrgCanvas.height), this.generatePixelMatrix(), this.previewImage()
    }
    export () {
        var t = document.createElement("a");
        t.download = this.selectedFileName + "-edited.png", t.href = this.operationEditedCanvas.toDataURL(), t.click()
    }
    genereateImageForExport () {
        return this.operationEditedCanvas.toDataURL();
    }
    previewImage(t, e, a) {
        ...
        null != e && 0 == e && (this.previewImageElement.addEventListener("mouseover", function(t) {
            ...
            i.relativeStartX = t.offsetX, i.relativeStartY = t.offsetY, i.ctrlPressed && i.pickColorPixel(i.relativeStartX, i.relativeStartY), i.selectStart = !1
        }), this.previewImageElement.addEventListener("mousedown", function(t) {
            i.selectStart = !0, i.startX = t.clientX, i.startY = t.clientY, i.relativeStartX = t.offsetX, i.relativeStartY = t.offsetY
        }), this.previewImageElement.addEventListener("mousemove", function(t) {
            i.endX = t.clientX, i.endY = t.clientY, i.selectStart && (i.selectRect.style.position = "fixed", i.selectRect.style.display = "initial", i.selectRect.style.border = "2px dashed black", i.selectRect.style.top = i.startY + "px", i.selectRect.style.left = i.startX + "px", i.selectRect.style.height = i.endY - i.startY + "px", i.selectRect.style.width = i.endX - i.startX + "px")
        }), this.previewImageElement.addEventListener("mouseup", function(t) {
            i.relativeEndX = t.layerX, i.relativeEndY = t.layerY, i.selectStart = !1, i.selectRect.style.height = "0px", i.selectRect.style.width = "0px", i.selectRect.style.display = "none"
        }), this.selectRect.addEventListener("mouseup", function(t) {
            i.selectStart = !1
        })), this.previewImageElement.src = null == t ? i.operationEditedCanvas.toDataURL() : t.toDataURL()
    }
    recreateImageObject() {
        this.image = new Image, this.image.src = this.operationOrgCanvas.toDataURL()
    }
    pickColorPixel(t, e) {
